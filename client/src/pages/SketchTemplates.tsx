...
export default function SketchTemplates() {
  ...
  const deleteTemplate = async (id: string) => {
    ...
    try {
      const res = await apiFetch(`/api/sketch-templates/${id}`, { method: "DELETE" });
      if (res.ok) {
              ...
              <Card key={t.id} className="hover:border-indigo-300 transition-colors shadow-sm">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <Button variant="outline" size="icon" onClick={() => deleteTemplate(t.id)} className="text-red-500 hover:bg-red-50">
